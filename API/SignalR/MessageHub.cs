...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var groupName = GetGroupName(currentUsername, other);
            ...
            var messages = await _uow.MessageRepository
                .GetMessageThread(currentUsername, other);
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var sender = await _uow.UserRepository.GetUserByUsernameAsync(senderUsername);
            var recipient = await _uow.UserRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername) ?? throw new HubException("Recipient not found!");
